 <form action="" method="post" name="frmCont" id="frmCont" class="form-horizontal" enctype="multipart/form-data" novalidate="novalidate">
    <div class="form-body">		
        <!-- <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" class="form-control required" name="order_id" id="order_id" value="" />
            </div>
        </div> -->
        <div class="form-group">
            <label for="product_name" class="control-label col-md-3">Product Details:</label> 
            <div class="col-md-4">
                <input type="text" class="form-control required" name="product_name" id="product_name" value="" />
            </div>
        </div>
         <div class="form-group">
            <label for="product_qty" class="control-label col-md-3">Product QTY:</label> 
            <div class="col-md-4">
                <input type="number" class="form-control required" name="product_qty" id="product_qty" value="" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" class="form-control required" name="courier_name" id="courier_name" value="" />
            </div>
        </div>
         <div class="form-group">
            <label for="enterd_weight" class="control-label col-md-3">Entered Weight:</label> 
            <div class="col-md-4">
                <input type="text" class="form-control required" name="enterd_weight" id="enterd_weight" value="%SHIP_WEIGHT%" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" class="form-control required" name="charged_weight" id="charged_weight" value="" />
            </div>
        </div>
          <div class="form-group">
            <label for="rest_of_india" class="control-label col-md-3">Discrepancy Proof:</label> 
            <div class="col-md-4">
                <input type="file" class="form-control required" name="proof" id="proof" value="" />
            </div>
        </div>
        ...
        <input type="hidden" name="action" id="action" value="addWeightDiscrepancy"><div class="flclear clearfix"></div>

<div class="col py-3 content">
  <form action="./api_call/install.php" method="post">
    <div class="row fields-instruction mt-4">
        <div class="col-auto fields"> 
            <div class="heading-icon ms-4">
              ...
              <img src="{SITE_IMG}shopify.png" alt="" width="100%" class="shopify mt-4">
              <p class="sub-heading">Enter your store details to get started</p>
            </div>
            <div class="input-group mb-3 top-input w-75 ms-4">
              <input type="text" id="storeName" name="storeName" class="form-control" placeholder="Store Name | eg: myfashionkart">
            </div>
            <div class="input-group mb-3 w-75 ms-4">
              <input type="text" id="storeUrl" name="storeUrl" class="form-control" placeholder="Store URL | eg: myshop.myshopify.com">
            </div>
            <button type="submit" class="btn btn-primary btn-connect ms-4">CONNECT</button> <br>
        </div>
